...
<StatCard label="Habit Streak" value="12 Days" icon={<Icon />} iconColor="orange.500" />;
```
...
<Card>
  <SectionHeader icon={SomeIcon} title="My Section" iconColor="blue.500" />
  <VStack spacing={4}>{/* Your content */}</VStack>
</Card>;
```
